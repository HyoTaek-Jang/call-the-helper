    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.topSection}>
          <Text style={styles.statusText}>전화가 왔어요</Text>
        ...
        <View style={styles.bottomSection}>
          <View style={styles.callAnswerControls}>
            {/* 거절 버튼 */}
            <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
              <TouchableOpacity
                style={[styles.answerButton, styles.declineButton]}
                onPress={() => handleButtonPress(handleDecline)}
                activeOpacity={0.8}
              >
            ...
            <Animated.View style={{ transform: [{ scale: scaleAnim }] }}>
              <TouchableOpacity
                style={[styles.answerButton, styles.acceptButton]}
                onPress={() => handleButtonPress(handleAccept)}
                activeOpacity={0.8}
              >
                <Ionicons name="call" size={32} color="white" />
              </TouchableOpacity>
